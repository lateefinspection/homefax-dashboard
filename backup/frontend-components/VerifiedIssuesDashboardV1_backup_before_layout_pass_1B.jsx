...
function getPlainLanguageFinding(issue) {
  ...
  if (text.includes("gfci") || text.includes("gfcis") || text.includes("ground fault")) {
  ...
  } else if (text.includes("main water supply") || text.includes("water supply") || text.includes("shut-off") || text.includes("shut off") || text.includes("valve")) {
    contractor = "Licensed plumber";
  ...
  } else if (text.includes("pipe support") || text.includes("drain") || text.includes("waste") || text.includes("vent")) {
    contractor = "Licensed plumber";
    plainTitle = "Plumbing pipe support needs correction";
    whatItMeans = "A drain, waste, vent, or plumbing pipe may not be properly supported.";
    whyItMatters = "Poor pipe support can lead to sagging, leaks, loose fittings, poor drainage, or future plumbing damage.";
    nextStep = "Have a licensed plumber secure the piping and check the affected area for leaks or drainage issues.";
      ...
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Click preview to inspect. Hide obvious junk locally.
          </p>
        </div>
          ...
          return (
            ...
            >
              <button
                ...
                title={`Preview candidate image ${index + 1}`}
              >
                <img
                  src={fullUrl}
              ...
              <div className="flex items-center justify-between gap-1 px-2 py-2">
                <button
                  ...
                  disabled={disabled}
                  className="rounded-lg bg-slate-900 px-2 py-1 text-xs font-semibold text-white disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Select #{index + 1}
                </button>
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
            <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Suggested photos are AI matches. Expand the image before approval. Verified photos require admin approval.
                </p>
              </div>
            </div>
