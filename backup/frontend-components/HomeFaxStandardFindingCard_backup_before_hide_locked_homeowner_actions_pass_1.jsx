        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              placeholder={
                baselineLocked
                  ? "This issue is baseline locked. Notes cannot be changed."
                  : "Add a note for this decision..."
              }
              disabled={baselineLocked || reviewBusy}
              className="mt-1 w-full rounded-2xl border border-slate-200 px-3 py-2 text-sm outline-none focus:border-slate-400 disabled:bg-slate-100 disabled:text-slate-500"
            />
          </div>
