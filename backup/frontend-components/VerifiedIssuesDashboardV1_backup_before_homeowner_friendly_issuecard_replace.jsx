        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Badge className={statusClass(issue.admin_image_decision)}>
                img decision: {issue.admin_image_decision || "pending"}
              </Badge>
              <Badge className={statusClass(issue.final_approval_status)}>
                final: {issue.final_approval_status || "not_approved"}
              </Badge>
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
            <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Suggested image becomes verified only after admin approval.
                </p>
              </div>
