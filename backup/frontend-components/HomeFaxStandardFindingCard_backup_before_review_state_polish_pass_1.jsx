...
export default function HomeFaxStandardFindingCard({ issue, apiBaseUrl, onRefresh }) {
  ...
  const currentStatus = pickFirst(issue.current_status, issue.status);
    ...
    <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="grid gap-4 p-5">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          {savedDecisionLabel || currentStatus || reviewedAt || savedHomeownerNote ? (
            <div className="mb-4 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-4">
              <div className="mb-3 text-sm font-black text-emerald-950">
                Saved Review State
              </div>

              <div className="grid gap-3 md:grid-cols-3">
                <ReviewStatePill label="Saved Decision" value={savedDecisionLabel} />
                <ReviewStatePill label="Current Status" value={currentStatus} />
